...
boton_punto = Button(root, text = ".", width = 9, height = 3, bg = "spring green", fg = "black",borderwidth = 0, cursor = "hand2", command = lambda: get(".")).grid(row = 4, column = 2, padx = 1, pady = 1)
